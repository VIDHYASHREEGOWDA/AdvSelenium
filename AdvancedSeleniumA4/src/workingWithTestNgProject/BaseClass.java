...
public class BaseClass {
	...
	String emailId = "vardhangowda@gmail.com";
	...
	public void login() throws InterruptedException {
		...
		driver.findElement(By.id("Email")).sendKeys("vardhangowda@gmail.com");
		driver.findElement(By.id("Password")).sendKeys("Vardhan123");
